                    ...
                    <div class="col-12 col-md-12 m-auto card p-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_en') is_invalid @enderror" id=""
                                placeholder="Category Name" name="name_en" value="{{ $doctor->name_en }}">
                            @error('name_en')
