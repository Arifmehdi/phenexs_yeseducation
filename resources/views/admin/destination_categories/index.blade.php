...
@section('title',"Admin Dashboard | All Destination Categories")
@section('body')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Destination Categories</h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive data-container">
                                @include('admin.destination_categories.search_data')
                            </div>
                        </div>
