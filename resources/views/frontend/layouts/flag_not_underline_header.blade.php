                                        ...
                                        <div class="megamenu-inner-wrapper">
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 column">
                                                    <ul>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 1</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 2</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 3</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 4</span> <i class="fas fa-phone-alt"></i></a></li>
                                                    </ul>
                                                </div>
                                                {{-- Column 2 --}}
                                                <div class="col-lg-3 column">
                                                    <ul>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 5</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 6</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 7</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 8</span> <i class="fas fa-phone-alt"></i></a></li>
                                                    </ul>
                                                </div>
                                                {{-- Column 3 --}}
                                                <div class="col-lg-3 column">
                                                    <ul>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 9</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 10</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 11</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 12</span> <i class="fas fa-phone-alt"></i></a></li>
                                                    </ul>
                                                </div>
                                                {{-- Column 4 --}}
                                                <div class="col-lg-3 column">
                                                    <ul>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 13</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 14</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 15</span> <i class="fas fa-phone-alt"></i></a></li>
                                                        <li><a><img src="https://via.placeholder.com/20x15" alt="Flag"> <span>Country 16</span> <i class="fas fa-phone-alt"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
<style>
    ...
    .main-header .navigation > li.dropdown > a:hover {
        text-decoration: none !important; /* Remove underline on hover for dropdown links */
    }
...
.navigation > li.dropdown > ul > li > a {
    ...
    padding: 10px 50px; /* Increase left padding to 50px */
...
.megamenu-inner-wrapper {
    ...
    padding: 0 50px; /* Desired left and right padding for content */
    width: 100%; /* Ensure it takes full width of its parent megamenu */
...
/* Styling for Location Megamenu specific items */
...
.navigation > li.dropdown .megamenu .col-lg-3.column ul li a {
    display: flex; /* Use flexbox for alignment */
    align-items: center; /* Vertically center items */
    padding: 8px 10px; /* Add some padding around each item */
    color: #ffffff; /* Ensure white text for country name */
    text-decoration: none !important; /* Ensure no underline */
    transition: background-color 0.3s ease;
    justify-content: flex-start; /* Align items to the start, icon will be at the end with margin-left: auto */
    white-space: nowrap; /* Prevent text wrapping */
}

.navigation > li.dropdown .megamenu .col-lg-3.column ul li a:hover {
    background-color: rgba(255, 255, 255, 0.1); /* Light hover effect */
}

.navigation > li.dropdown .megamenu .col-lg-3.column ul li a img {
    width: 24px; /* Adjust flag size */
    height: 18px; /* Adjust flag size, maintain aspect ratio */
    margin-right: 10px; /* Space between flag and country name */
    border: 1px solid rgba(255, 255, 255, 0.3); /* Subtle border for flags */
    flex-shrink: 0; /* Prevent flag from shrinking */
}

.navigation > li.dropdown .megamenu .col-lg-3.column ul li a span {
    flex-grow: 1; /* Allow country name to take available space */
    color: #ffffff; /* Explicitly set country name to white */
    font-size: 15px;
    overflow: hidden; /* Hide overflow if text is too long */
    text-overflow: ellipsis; /* Add ellipsis for long text */
}

.navigation > li.dropdown .megamenu .col-lg-3.column ul li a .fas.fa-phone-alt {
    color: #74C7F4; /* Icon color, same as courses */
    font-size: 16px;
    margin-left: 10px; /* Space between country name and icon */
