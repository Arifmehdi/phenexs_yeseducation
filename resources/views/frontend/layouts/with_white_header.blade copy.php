...
.navigation > li.dropdown:hover .megamenu {
    ...
    .mobile-navigation .navigation > li {
        border-radius: 5px; /* Retained for parent li */
        margin-bottom: 8px; /* Separates the boxes */
        /* overflow: hidden; Removed as border-radius is on 'a' */
        /* border-bottom: none; Handled by margin-bottom */
    }
    ...
    .mobile-navigation .navigation li a {
        display: block;
        padding: 12px 15px; /* Adjusted padding for box effect */
        color: #333;
        text-decoration: none;
        font-weight: normal;
        font-size: 14px;
        transition: background 0.2s ease, color 0.2s ease;
        background-color: #f8f9fa; /* Background for the radius box */
    ...
    .mobile-navigation .navigation li .megamenu li a {
        padding: 12px 15px 12px 35px; /* Adjusted padding for nesting and box effect */
        font-size: 14px;
        font-weight: 400;
        color: #555;
        background-color: #fff; /* Background for the radius box */
        border-radius: 5px; /* Rounded corners for the box */
    }
    ...
    .mobile-navigation .navigation li .megamenu .column ul li {
        margin-bottom: 5px; /* Separates the boxes */
        /* border-radius and overflow moved to 'a' tag */
    }
