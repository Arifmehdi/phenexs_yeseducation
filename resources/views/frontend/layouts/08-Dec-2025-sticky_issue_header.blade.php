                        ...
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('studyInUk', 'Why Choose UK') }}">
                                                                ...
                                                                <p>Discover why the UK is great for both education and culture.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'What Can I Study?') }}">
                                                                ...
                                                                <p>Art, science, philosophy... Explore your options to find your passion.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('studyInUk', 'January Intake') }}">
                                                                ...
                                                                <span>January Intake</span>
                                                                <p>Find out all you need to know about courses starting in January.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('studyInUk', 'May Intake') }}">
                                                                ...
                                                                <p>Find out all you need to know about courses starting in May.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('search', ['action' => 'location-data', 'location' => 'London']) }}">
                                                                ...
                                                                <p>Browse over 150 top universities to find the perfect place to study.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Rankings') }}">
                                                                ...
                                                                <span>Rankings</span>
                                                                <p>Choose from the best UK universities using our comprehensive rankings guide.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'University Of Scotland') }}">
                                                                ...
                                                                <span>University Of Scotland</span>
                                                                <p>Choose from the best UK universities using our comprehensive rankings guide.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Discover Russell Group universities known for their research excellence and prestige.') }}">
                                                                <img src="{{ asset('frontend/assets/images/university/russelGroupUniversity.png') }}" alt="Title">
                                                                <span>Russell Group Industries</span>
                                                                <p>Discover Russell Group universities known for their research excellence and prestige.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Top Universities In the UK') }}">
                                                                ...
                                                                <span>Top Universities In the UK</span>
                                                                <p>Choose from the best UK universities using our comprehensive rankings guide.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Foundation') }}">
                                                                ...
                                                                <p>Foundation courses help international students get ready for university.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Undergraduate Degree') }}">
                                                                ...
                                                                <p>Explore undergraduate degrees in the UK for almost any career path.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Top-Up Degrees') }}">
                                                                ...
                                                                <span>Top-Up Degrees</span>
                                                                <p>Learn about Top-Up degrees to complete your degree.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Pre-Masters') }}">
                                                                ...
                                                                <p>Find Pre-Masters programs in the UK to prepare you for postgraduate study.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'Masters Degree') }}">
                                                                ...
                                                                <p>Explore Master's degrees in the UK for further academic and career growth.</p>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="service-item" href="{{ route('eventDetails', 'PhD-Degree') }}">
                                                                ...
                                                                <p>Discover PhD opportunities in the UK for advanced research and expertise.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('event') }}">
                                                                ...
                                                                <span>Event</span>
                                                                <p>Discover top institutes offering pathway programs to prepare for university.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a class="service-item" href="{{ route('blog') }}">
                                                                ...
                                                                <span>Our Blogs</span>
                                                                <p>Explore pathway courses designed to bridge your academic journey.</p>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <li class="{{ request()->routeIs('application') ? 'active current' : '' }}">
                                    <a href="{{ route('application') }}"><span class="apply-now-text">Apply Now ></span></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                ...
                <div class="header-right-elements">
                    ...
                    <a href="tel:+8801898828980">
                        <button class="btn phone-button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="phone-icon">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"></path>
                            </svg>
                            <span class="phone-number">+8801898-828980</span>
                        </button>
                    </a>
                </div>
            </div>
...
@media (min-width: 992px) and (max-width: 1415px) {
    ...
    .header-right-elements .btn.phone-button {
...
/* ==================== RESPONSIVE FIXES FOR 1416px AND ABOVE ==================== */
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- Responsive Menu Optimization for Medium Screens ---
    function optimizeMenuForMediumScreens() {
        const navigation = document.querySelector('.main-header .navigation');
        const menuArea = document.querySelector('.menu-area');
        
        if (window.innerWidth >= 992 && window.innerWidth <= 1415) {
            ...
            // Ensure menu stays in single row
            if (menuArea) {
                menuArea.style.overflowX = 'visible';
                menuArea.style.overflowY = 'visible';
            }
        }
    }
    
    // Run on load and resize
    optimizeMenuForMediumScreens();
    window.addEventListener('resize', optimizeMenuForMediumScreens);
});
</script>