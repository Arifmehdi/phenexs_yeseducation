        ...
        <div class="container-fluid">
            <div class="outer-box clearfix">
                        ...
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown {{ request()->routeIs('service') ? 'active current' : '' }} has-submenu">
                                    <a href="{{ route('service') }}">Courses</a>
                                    <ul class="mobile-submenu d-block d-lg-none d-md-none ">
                ...
                <div class="header-right-elements">
                    ...
                    <a href="{{ route('consultation') }}"><button class="btn " style="background: #3B308B">Free Consultation</button></a>
                </div>
...
@media (min-width: 768px) and (max-width: 991px) {
    ...
    .mobile-floating-menu .navigation li a {
        font-size: 16px !important;
        padding: 15px 25px !important;
    }
    
    .mobile-navigation .megamenu .row .column {
...
/* Responsive for screens 1100px and below */
...
/* Fix for menu overflow on medium screens */
.navigation {
...
/* Fix button text on smaller screens */
.header-right-elements .btn {
    white-space: nowrap !important;
...
/* Mega Menu Responsiveness for tablets */
@media (min-width: 992px) and (max-width: 1300px) {
    ...
    .megamenu .col-lg-6:last-child,
    .megamenu .col-lg-3:last-child {
...
/* Show mobile header icons on mobile devices */
@media (max-width: 991px) {
    .mobile-header-icons {
        display: flex !important;
        position: static;
    ...
    .header-upper .header-right-elements {
        display: none !important;
    }
    ...
    .mobile-floating-menu.active .mobile-nav-toggler .icon-bar:nth-child(1) {
        transform: rotate(45deg) translate(5px, 5px);
    }
    
    .mobile-floating-menu.active .mobile-nav-toggler .icon-bar:nth-child(2) {
        opacity: 0;
    }
    
    .mobile-floating-menu.active .mobile-nav-toggler .icon-bar:nth-child(3) {
...
/* Fix for 1200-1400px specific issues */
...
/* Make sure hamburger menu container is visible on mobile */
@media (max-width: 991px) {
    .mobile-header-icons {
        display: flex !important;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const closeBtn = document.querySelector('.mobile-floating-menu .close-btn');
    ...
    if (mobileNav) {
        const dropdowns = mobileNav.querySelectorAll('li.dropdown, li.has-submenu');
        ...
        dropdowns.forEach(dropdown => {
            ...
            if (link) {
                link.addEventListener('click', function(e) {
                    ...
                    const hasSubmenu = nextEl && (
                        nextEl.tagName === 'UL' || 
                        nextEl.classList.contains('megamenu') || 
                        nextEl.classList.contains('mobile-submenu')
                    );
    ...
    function adjustMenuForScreenSize() {
        ...
        if (navigation && windowWidth <= 1100 && windowWidth > 991) {
            // Reduce menu item padding on medium screens
            ...
            // Adjust button size
            if (rightElements) {
                const button = rightElements.querySelector('.btn');
                if (button) {
        ...
        // Adjust mega menu for medium screens
    ...
    // Remove any existing mobile dropdown icons
